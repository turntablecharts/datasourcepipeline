...
CREATE TABLE IF NOT EXISTS streaming_ingestion_run_log_events (
...
CREATE INDEX IF NOT EXISTS idx_streaming_run_events_run_created
    ON streaming_ingestion_run_log_events (ingestion_run_id, created_at);
CREATE INDEX IF NOT EXISTS idx_streaming_run_events_level_created
